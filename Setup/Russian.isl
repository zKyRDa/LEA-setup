...
SetupWindowTitle=Установка Law Enforcer Assistant
...
; *** SetupLdr messages
SetupLdrStartupMessage=Данная программа установит Law Enforcer Assistant на ваш компьютер, продолжить?
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует Мастер установки Law Enforcer Assistant
WelcomeLabel2=Программа установит Law Enforcer Assistant на ваш компьютер.%n%nРекомендуется закрыть все прочие приложения перед тем, как продолжить.
...
SelectDirLabel3=Укажите путь до ПАПКИ С ИГРОЙ
SelectDirBrowseLabel=Если вы играете на аризоне, то чтобы получить путь до папки c игрой, откройте лаунчер, нажмите на шестёрнку и кликните на иконку папки перед "путь установки игры"
...
SelectTasksLabel2=Выберите дополнительные задачи, которые должны выполниться при установке Law Enforcer Assistant, после этого нажмите «Далее»:
...
ReadyLabel1=Программа установки готова начать установку Law Enforcer Assistant на ваш компьютер.
ReadyLabel2a=Нажмите «Установить», чтобы продолжить, или «Назад», если вы хотите изменить путь до корня игры.
...
PreparingDesc=Программа установки подготавливается к установке Law Enforcer Assistant на ваш компьютер.
PreviousInstallNotCompleted=Установка или удаление предыдущей программы не были завершены. Вам потребуется перезагрузить компьютер, чтобы завершить ту установку.%n%nПосле перезагрузки запустите вновь Программу установки, чтобы завершить установку Law Enforcer Assistant.
...
InstallingLabel=Пожалуйста, подождите, пока Law Enforcer Assistant установится на ваш компьютер.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение Мастера установки Law Enforcer Assistant
FinishedLabelNoIcons=Программа Law Enforcer Assistant установлена на ваш компьютер.
FinishedLabel=Программа Law Enforcer Assistant установлена на ваш компьютер. Приложение можно запустить с помощью соответствующего значка.
ClickFinish=Нажмите «Завершить», чтобы выйти из программы установки.
FinishedRestartLabel=Для завершения установки Law Enforcer Assistant требуется перезагрузить компьютер. Произвести перезагрузку сейчас?
FinishedRestartMessage=Для завершения установки Law Enforcer Assistant требуется перезагрузить компьютер.%n%nПроизвести перезагрузку сейчас?
